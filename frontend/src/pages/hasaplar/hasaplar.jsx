                ...
                <table className="w-full border-collapse ">
                    <thead>
                        <tr className="border-b-2">
                            ...
                            <th className="py-4 px-5 font-roboto">Puly alan</th>
                            <th className="py-4 px-5 font-roboto">
                                Hakyky alynan pul
                            </th>
                            <th className="py-4 px-5 font-roboto">
                                Terminala salynan pul
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr className="border-b-2">
                            <th
                                colSpan={3}
                                className="py-4 pl-8  !max-w-[150px] text-left px-5 font-roboto"
                            >
                                Jemi
                            </th>
                            <th className="py-4 px-5 font-roboto">
...
export default React.memo(Hasaplar);
